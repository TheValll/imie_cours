...
class User {
    ...
    public function __construct(int $pIdUser,string $pUsername, string $pEmail, string $pPassword)
    {
        $this->idUser = $pIdUser;
...
class ManageUsers {
    public function addUser(string $pUsername, string $pEmail, string $pPassword) {
