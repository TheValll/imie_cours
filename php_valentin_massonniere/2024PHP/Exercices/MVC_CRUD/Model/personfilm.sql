...
(3, 'La Reguerre des re-Etoiles 14'),
(4, 'Les meilleurs moments des CDA 2023');
...
(1, 'Onette', 'Camille', 'Mineur'),
(2, 'Dormi', 'Djamal', 'Majeur'),
(3, 'MéamonterLesEscaliers', 'Edmé', 'Majeur'),
(4, 'Ebasque', 'Albert', 'Mineur');
