...
class Film {
    ...
    public function __construct(int $pid, string $pname){
        $this->idFilm = $pid;
        $this->name = $pname;
    }
    ...
    public function addPerson(int $pIdPerson){
...
class ManageFilms {
    ...
    public function getFilmFromId(int $id){
    ...
    public function getFilmOffsetFromId(int $id){
    ...
    public function addFilm(string $pname) {
    ...
    public function addPersonToFilm(int $pIdFilm, int $pIdPerson){
    ...
    public function modifyFilm(int $pid, int $pname) {
        // modifie les données en Bd et dans l'objet 
        // A implémenter
    }

    public function deletePersonInFilms(int $pidPerson){
